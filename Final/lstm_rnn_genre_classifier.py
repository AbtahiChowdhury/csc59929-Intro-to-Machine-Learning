...
def plot_history(history):
    ...
    plt.savefig(f'./pictures/rnn_lstm_{EPOCHS}_epochs_accuracy_plot.png')
    ...
    plt.savefig(f'./pictures/rnn_lstm_{EPOCHS}_epochs_error_plot.png')
...
def plot_confusion_matrix(con_mat_df):
    ...
    plt.savefig(f'./pictures/rnn_lstm_{EPOCHS}_epochs_confusion_matrix.png')
